# genpark-full-codebase-dependency-graph-pr-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Full-codebase dependency graph indexer & automated PR synthesizer (Greptile style)
